...
import 'package:consultant_product/src/modules/wallet/flutterwave_payment/repo.dart';
...
class FlutterWaveWalletDeposit extends StatefulWidget {
  // String? amount;
  // FlutterWaveWalletDeposit({Key? key, this.amount}) : super(key: key);

  @override
  _FlutterWaveWalletDepositState createState() => _FlutterWaveWalletDepositState();
}

class _FlutterWaveWalletDepositState extends State<FlutterWaveWalletDeposit> {
