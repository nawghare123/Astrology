class DepositWalletModel {
  ...
  DepositWalletModel.fromJson(dynamic json) {
    ...
    _data = json['data'] != null ? DepositWalletModelData.fromJson(json['data']) : null;
    _msg = json['msg'];
  }
  bool? _status;
  int? _success;
...
class DepositWalletModelData {
  ...
  DepositWalletModelData.fromJson(dynamic json) {
    _transaction = json['transaction'] != null ? DepositTransactionModel.fromJson(json['transaction']) : null;
  }
