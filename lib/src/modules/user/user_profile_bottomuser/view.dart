...
class UserProfilebottom extends StatefulWidget {
  const UserProfilebottom({Key? key}) : super(key: key);

  @override
  State<UserProfilebottom> createState() =>
      _EditUserProfilePageState();
}

class _EditUserProfilePageState extends State<UserProfilebottom> {
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        EdgeInsetsDirectional.fromSTEB(
                                            25.w, 15.h, 25.w, 15.h),
                                        hintText: LanguageConstant.dateOfBirth.tr,
                                        hintStyle: state.hintTextStyle,
                                        fillColor: Colors.white,
                                        filled: true,
                                        enabledBorder: OutlineInputBorder(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (pickedDate != null) {
                                          ...
                                          print(
                                              formattedDate);
                                          setState(() {
                                            _editUserProfileLogic.dateInput.text =
                                                formattedDate;
                                          });
                                        } else {}
                                      },
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        EdgeInsetsDirectional.fromSTEB(
                                            25.w, 15.h, 25.w, 15.h),
                                        hintText: LanguageConstant.timeofBirth.tr,
                                        hintStyle: state.hintTextStyle,
                                        fillColor: Colors.white,
                                        filled: true,
                                        enabledBorder: OutlineInputBorder(
                                      ...
                                      onTap: () async {
                                        ...
                                        if(pickedTime != null ){
                                          ...
                                          setState(() {
                                            _editUserProfileLogic.TimeInput.text =
                                                formattedTime;
                                          });
