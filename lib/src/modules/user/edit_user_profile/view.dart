...
class EditUserProfilePage extends StatefulWidget {
  final bool wannaShowBackButton;
  EditUserProfilePage({Key? key, required this.wannaShowBackButton})
      : super(key: key);
                  ...
                  return <Widget>[
                    ...
                    SliverAppBar(
                      ...
                      backgroundColor: _editUserProfileLogic.isShrink
                          ? customThemeColor
                          : Colors.transparent,
                      leading: widget.wannaShowBackButton
                          ? InkWell(
                              onTap: () {
                                Get.back();
                              },
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _editUserProfileLogic.dateInput,
                                      decoration: InputDecoration(
                                        contentPadding:
                                            EdgeInsetsDirectional.fromSTEB(
                                                25.w, 15.h, 25.w, 15.h),
                                  ...
                                  Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _editUserProfileLogic.TimeInput,
                                      decoration: InputDecoration(
                                        contentPadding:
                                            EdgeInsetsDirectional.fromSTEB(
                                                25.w, 15.h, 25.w, 15.h),
                                        hintText:
                                            LanguageConstant.timeofBirth.tr,
                                        hintStyle: state.hintTextStyle,
                                        fillColor: Colors.white,
                                        filled: true,
                                        enabledBorder: OutlineInputBorder(
                                  ...
                                  child: Padding(
                                    ...
                                    child: ButtonTheme(
                                      ...
                                      child:
                                        ...
                                        value: _editUserProfileLogic.selectedCity,
                                        hint: "Select one",
                                        searchHint: "Select one",
                                        onChanged: (String? value) {
                                          setState(() {
