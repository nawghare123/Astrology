...
import 'package:consultant_product/src/modules/consultant/appointment/appointmenttypeclass.dart';
...
class ConsultantCallPage extends StatefulWidget {
  const ConsultantCallPage({Key? key}) : super(key: key);

  @override
  State<ConsultantCallPage> createState() => _ConsultantCallPageState();
}

class _ConsultantCallPageState extends State<ConsultantCallPage> {
            ...
            body: NestedScrollView(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(LanguageConstant.callUs.tr,
                ...
                body: !isloading
                    ? ListView(
                        ...
                        children: [
                            //  for(int i =0; i<appointmenttypemodel!.data!.data!.length; i++)
...
logic.audioOnTap(context);
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Material(
                                                                          ...
                                                                          child: appointmenttypemodel!.data!.data![index].imagePath == null
                                                                              ? SizedBox(
                                                                                  width: 76.w,
                                                                                  height: 85.h,
                                                                                )
 ...
 for (int  r = 0; r<appointmenttypemodel!.data!.data![index].religion!.length; r++)
                                                                        ...
                                                                        Column(
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              ...
                                                                              style: state.topSubTitleTextStyle!.copyWith(color: (appointmenttypemodel!.data!.data![index].onlineStatus == "online") ? Colors.green : Colors.red),
                                                                            ),
                            ...
                            //                                                       borderRadius: BorderRadius.circular(8.r),
                            //                                                       child: Image.network(
                            //                                                         "https://astro.hirectjob.in/" + appointmenttypemodel!.data.data[index].imagePath.toString(),
                            //                                                         // _userHomeLogic.topRatedConsultantList[index].image!.contains('assets')
                            //                                                         //     ? '$mediaUrl${_userHomeLogic.topRatedConsultantList[index].image}'
                            //                                                         //     : '${_userHomeLogic.topRatedConsultantList[index].image}',
                            //                                                         width: 76.w,
                            ...
                            //                                                 ///---title
                            //                                                 Text(appointmenttypemodel!.data.data[index].firstName.toString(),
                            //                                                     softWrap: true,
                            //                                                     overflow: TextOverflow.ellipsis,
                            //                                                     maxLines: 1,
                            ...
                            //                                                 // RatingBar.builder(
                            //                                                 //   ignoreGestures: true,
                            //                                                 //   initialRating: double.parse(appointmenttypemodel!.data.data[index].ratingCount.toString()),
                            //                                                 //   minRating: 1,
                            ...
                            //                                                 (
                            //                                                         //AppointmentTypeStringEnum
                            //                                                         (appointmenttypemodel!.data.data[index].name![j].name) ==
                            //                                                         "audio")
                            //                                                     ? "Call"
                            //                                                     : "",
                            //                                                 style:
