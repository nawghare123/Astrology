...
class ConsultantChatlist extends StatefulWidget {
  const ConsultantChatlist({Key? key}) : super(key: key);

  @override
  State<ConsultantChatlist> createState() => _ChatlistState();
}

class _ChatlistState extends State<ConsultantChatlist> {
 ...
 for (int  r = 0; r<appointmenttypemodel!.data!.data![index].religion!.length; r++)
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child: Center(
                                                                            ...
                                                                            (
                                                                                    ...
                                                                                    (appointmenttypemodel!.data!.data![index].appointmentTypeId![j][0].name!.toString()) == "chat")
                                                                                ? "Chat"
                                                                                : "",
                                                                            style: TextStyle(
                                                                                fontSize:
                            ...
                            //                                                 // RatingBar.builder(
                            //                                                 //   ignoreGestures: true,
                            //                                                 //   initialRating: double.parse((appointmenttypemodel!.data.data[index].ratingCount??0).toString()),
                            //                                                 //   minRating: 1,
                            ...
                            //                                                 (
                            //                                                         //AppointmentTypeStringEnum
                            //                                                         (appointmenttypemodel!.data.data[index].name![j].name) == "chat")
                            //                                                     ? "Chat"
                            //                                                     : "",
                            //                                                 style:
                            //                                                     TextStyle(fontSize: 12),
